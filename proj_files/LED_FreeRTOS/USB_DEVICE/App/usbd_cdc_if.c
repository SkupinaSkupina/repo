...
/* USER CODE BEGIN PV */
/* Private variables ---------------------------------------------------------*/
#define BUFFER_SIZE 128  // Nastavi velikost medpomnilnika

char buffer[BUFFER_SIZE];  // Medpomnilnik za prejemanje podatkov
uint32_t bufferIndex = 0;  // Indeks za sledenje vnosu v medpomnilnik
/* USER CODE END PV */
